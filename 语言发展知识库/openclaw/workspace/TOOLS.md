...
- 再创建对应的 `development_card` 或 `practice_card`
- 文件命名遵循 `book-0001-short-slug.md`、`note-0001-short-slug.md`、`stage-0001-short-slug.md`、`practice-0001-short-slug.md`、`collection-0001-short-slug.md`
